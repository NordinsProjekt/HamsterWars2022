...
namespace HamsterWarsDatabaseSQL.Migrations
{
    ...
    [Migration("20221207122806_UpdatedStuff")]
            ...
            modelBuilder.Entity("HamsterWars_DatabaseSQL.Models.Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            IsCompleted = false,
                            StartDate = new DateTime(2022, 12, 7, 13, 28, 6, 736, DateTimeKind.Local).AddTicks(1237)
                        },
                        new
                        {
                            Id = 2,
                            IsCompleted = true,
                            StartDate = new DateTime(2022, 12, 7, 13, 28, 6, 736, DateTimeKind.Local).AddTicks(1269)
                        },
                        new
                        {
                            Id = 3,
                            IsCompleted = false,
                            StartDate = new DateTime(2022, 12, 7, 13, 28, 6, 736, DateTimeKind.Local).AddTicks(1272)
                        },
                        new
                        {
                            Id = 4,
                            IsCompleted = false,
                            StartDate = new DateTime(2022, 12, 7, 13, 28, 6, 736, DateTimeKind.Local).AddTicks(1273)
                        },
                        new
                        {
                            Id = 5,
                            IsCompleted = true,
                            StartDate = new DateTime(2022, 12, 7, 13, 28, 6, 736, DateTimeKind.Local).AddTicks(1275)
                        },
                        new
                        {
                            Id = 6,
                            IsCompleted = true,
                            StartDate = new DateTime(2022, 12, 7, 13, 28, 6, 736, DateTimeKind.Local).AddTicks(1276)
                        },
                        new
                        {
                            Id = 7,
                            IsCompleted = true,
                            StartDate = new DateTime(2022, 12, 7, 13, 28, 6, 736, DateTimeKind.Local).AddTicks(1278)
                        });
                });
