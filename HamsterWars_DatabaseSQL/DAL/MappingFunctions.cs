...
namespace HamsterWars_DatabaseSQL.DAL
{
    public static class MappingFunctions
    {
        ...
        public static Vote MapVoteDTOToVote(VoteDTO vote)
            => vote.Adapt<Vote>();
        public static TournamentDTO MapTournamentToTournamentDTO(Tournament tournament)
        ...
        public static List<HamsterMiniDTO> MapHamsterToHamsterMiniDTOList(List<Hamster> hamsterList)
            => hamsterList.Adapt<List<HamsterMiniDTO>>();
    }
}
